...
/*
    ELSIF p_action = 'UPDATE' THEN
        ...
        UPDATE integracion.SZRTMBP
           SET SZRTMBP_DESC          = p_desc,
               SZRTMBP_START_DATE    = p_start_date,
               SZRTMBP_END_DATE      = p_end_date,
               SZRTMBP_STATE         = 'NEW',
               SZRTMBP_OPERACION      = 'U',
               SZRTMBP_VERSION       = NVL(SZRTMBP_VERSION,0) + 1,
               SZRTMBP_USER_ID       = USER,
